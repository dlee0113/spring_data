            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <div class="nav-collapse">
                        ...
                        <form id="contact-search-form" class="navbar-search pull-right" action="">
                            <input id="contact-search-query" class="search-query span2" type="text" placeholder="<spring:message code="placeholder.search.field"/>">
                        </form>
                    </div>
                </div>
            </div>
