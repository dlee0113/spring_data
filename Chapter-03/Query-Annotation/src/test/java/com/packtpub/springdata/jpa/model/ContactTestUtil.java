...
public class ContactTestUtil {
    ...
    public static Contact createModel(Long id) {
        return createContact(id, FIRST_NAME, LAST_NAME);
    }

    public static Contact createContact(Long id, String firsName, String lastName) {
        Contact contact = Contact.getBuilder(firsName, lastName)
