...
/**
 * This test context is used to unit test the ContactSpecifications class.
 * If the entity manager factory is not initialized before tests are executed,
 * the static meta model is not initialized properly and tests fail because of that.
 *
