...
public class RepositoryContactService implements ContactService {
    ...
    public long count(SearchDTO dto) {
        ...
        LOGGER.debug("Getting count with like pattern: {}", likePattern);

        return repository.countContacts(likePattern);
    }
    ...
    public List<Contact> search(SearchDTO dto) {
        ...
        String likePattern = buildLikePattern(dto.getSearchTerm());
        LOGGER.debug("Searching contacts with like pattern: {}", likePattern);
    ...
    /**
     * Builds a like pattern which compares the given search term with the
     * start of a string.
     * @param searchTerm    The given search term.
     * @return  The created like pattern.
     */
