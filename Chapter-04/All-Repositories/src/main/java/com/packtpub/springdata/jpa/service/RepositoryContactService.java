...
public class RepositoryContactService implements ContactService {
    ...
    public long count(SearchDTO dto) {
        ...
        return repository.count(firstOrLastNameStartsWith(dto.getSearchTerm()));
    }
    ...
    public List<Contact> search(SearchDTO dto) {
        ...
        Page<Contact> page = repository.findAll(firstOrLastNameStartsWith(dto.getSearchTerm()), buildPageSpecification(dto.getPageIndex(), dto.getPageSize()));
