...
<form:form action="/contact/add" cssClass="well" commandName="contact" method="POST">
    ...
    <div id="control-group-streetAddress" class="control-group">
        ...
        <div class="controls">
            <form:input id="contact-streetAddress" path="address.streetAddress"/>
            <form:errors id="error-streetAddress" path="address.streetAddress" cssClass="help-inline"/>
        </div>
    </div>
    <div id="control-group-postCode" class="control-group">
        ...
        <div class="controls">
            <form:input id="contact-postCode" path="address.postCode"/>
            <form:errors id="error-postCode" path="address.postCode" cssClass="help-inline"/>
        </div>
    </div>
    <div id="control-group-postOffice" class="control-group">
        ...
        <div class="controls">
            <form:input id="contact-postOffice" path="address.postOffice"/>
            <form:errors id="error-postOffice" path="address.postOffice" cssClass="help-inline"/>
        </div>
    </div>
    <div id="control-group-state" class="control-group">
        ...
        <div class="controls">
            <form:input id="contact-state" path="address.state"/>
            <form:errors id="error-state" path="address.state" cssClass="help-inline"/>
        </div>
    </div>
    <div id="control-group-country" class="control-group">
        ...
        <div class="controls">
            <form:input id="contact-country" path="address.country"/>
            <form:errors id="error-country" path="address.country" cssClass="help-inline"/>
        </div>
    </div>
