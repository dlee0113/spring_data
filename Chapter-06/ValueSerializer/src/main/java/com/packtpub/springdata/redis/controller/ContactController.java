...
public class ContactController {
    ...
    public String addContact(@Valid @ModelAttribute(MODEL_ATTRIBUTE_CONTACT) Contact dto, BindingResult result, RedirectAttributes attributes) {
    ...
    public String showUpdateContactPage(@PathVariable("id") Long id, Model model) throws NotFoundException {
        ...
        model.addAttribute(MODEL_ATTRIBUTE_CONTACT, updated);
    ...
    public String updateContact(@Valid @ModelAttribute(MODEL_ATTRIBUTE_CONTACT) Contact dto, BindingResult result, RedirectAttributes attributes) throws NotFoundException {
